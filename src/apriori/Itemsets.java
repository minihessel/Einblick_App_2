...
/**
 * This class represents a set of itemsets, where an itemset is an array of integers with an associated support count. Itemsets are ordered by size. For example, level 1 means itemsets of size 1 (that contains 1 item).
 *
