...
//	/**
//	 * Method to check if a sorted list of integers "itemset1" 
//	 * contains all integers from another sorted list of integers "itemset2".
//	 * @param itemset1 the first itemset
//	 * @param itemset2 the second itemset
//	 * @return true if itemset2 is contained in itemset1
//	 */
//	public static boolean contains(int[] itemset1, int[] itemset2) {
